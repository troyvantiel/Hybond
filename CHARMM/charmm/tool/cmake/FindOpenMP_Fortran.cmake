...
function(_OPENMP_FLAG_CANDIDATES)
  ...
  elseif(CMAKE_Fortran_COMPILER_ID MATCHES "Intel" AND
      "${CMAKE_Fortran_COMPILER_VERSION}" VERSION_LESS "15.0")
  ...
  if(OMP_FLAG_${CMAKE_Fortran_COMPILER_ID})
    list(REMOVE_ITEM OpenMP_FLAG_CANDIDATES "${OMP_FLAG_${CMAKE_Fortran_COMPILER_ID}}")
    list(INSERT OpenMP_FLAG_CANDIDATES 0 "${OMP_FLAG_${CMAKE_Fortran_COMPILER_ID}}")
  endif()

  set(OpenMP_Fortran_FLAG_CANDIDATES "${OpenMP_FLAG_CANDIDATES}" PARENT_SCOPE)
endfunction()
...
if(_OPENMP_REQUIRED_VARS)
  ...
  find_package_handle_standard_args(OpenMP_Fortran
  ...
  message(SEND_ERROR "FindOpenMP requires Fortran language to be enabled")
endif()
