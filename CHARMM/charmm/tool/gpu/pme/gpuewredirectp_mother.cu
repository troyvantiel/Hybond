...
#include <sys/time.h>
#include <gpuheader.h>
#include <gpuewredirectp_kernel.cu>
////////////////////////////////////////////////////////////////////////////////
extern "C"
void gpuewredirectp_ 
(double*, int, double*, double, int, double*, int, int, double*, double*, int, int, int);
void gpuewredirectp__
(double*, int, double*, double, int, double*, int, int, double*, double*, int, int, int);
 ...
 int begin_numi, int num_atmi)
{
  ...
  gpuewredirectp_kernel<<< grid, threads >>>
    (f_dev, x_dev, xi_dev, n, xmax_float0, xmax_float1, xmax_float2,
     rcp_xmax0, rcp_xmax1, rcp_xmax2, rcut);
