...
__inline__ float calc_dtmp_vdw(float r1, float r2, float r6, 
#ifdef VDW_SHIFT
 ...
 */
{
#if MD_LJ_05SIGMA_8SIGMA==2 && defined(COULOMB_SHIFT) && defined(VDW_SHIFT) && defined(VG_GCC)
  // not work well
