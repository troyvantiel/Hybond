...
//#define MD_PRINT_WARN                // print warning message for development comment
//#define MD_MEASURE_TIME       100    // print timing. number means number of times
#define MD_GENERATE_EMUTABLE         // generate r1 and rsqr table for GPU emulator
                                     // on the fly. If environmental variable 'VG_EMUDIR'
                                     // is defined, table file is read instead of generaging.
...
#define MD_CELLINDEX_MAXCELL_PER_DIM 32
...
#define MD_R1_EMU_MD5SUM      "36f6a6fa6677286846396aecd641380a"
#define MD_RSQRT_EMU_MD5SUM   "c1c70d9eb51d140d58094524415dd0c5"
...
typedef struct {
  ...
  /*
    ci[icell][0-26] -- base and size of j-cell
             [27] ---- number of j-cells is stored at 'size'
   */
