...
**Outline:**
  ...
  * :ref:`ref-cmd-grid-cite`
  * :ref:`ref-cmd-grid-syntax`
  * :ref:`ref-cmd-grid-misc`
  * :ref:`ref-cmd-grid-warnings`
  * :ref:`ref-cmd-grid-examples`
...
When publishing results obtained using the GRID command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-grid-syntax:
