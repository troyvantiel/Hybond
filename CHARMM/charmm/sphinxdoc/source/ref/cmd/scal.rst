...
**Outline:**
  ...
  * :ref:`ref-cmd-scal-cite`
  * :ref:`ref-cmd-scal-syntax`
  * :ref:`ref-cmd-scal-misc`
  * :ref:`ref-cmd-scal-warnings`
  * :ref:`ref-cmd-scal-examples`
...
When publishing results obtained using the SCAL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-scal-syntax:
