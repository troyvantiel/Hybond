...
**Outline:**
  ...
  * :ref:`ref-cmd-bloc-cite`
  * :ref:`ref-cmd-bloc-syntax`
  * :ref:`ref-cmd-bloc-misc`
  * :ref:`ref-cmd-bloc-warnings`
  * :ref:`ref-cmd-bloc-examples`
...
When publishing results obtained using the BLOC command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-bloc-syntax:
