...
**Outline:**
  ...
  * :ref:`ref-cmd-fluc-cite`
  * :ref:`ref-cmd-fluc-syntax`
  * :ref:`ref-cmd-fluc-misc`
  * :ref:`ref-cmd-fluc-warnings`
  * :ref:`ref-cmd-fluc-examples`
...
When publishing results obtained using the FLUC command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-fluc-syntax:
