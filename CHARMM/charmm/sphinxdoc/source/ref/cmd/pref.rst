...
**Outline:**
  ...
  * :ref:`ref-cmd-pref-cite`
  * :ref:`ref-cmd-pref-syntax`
  * :ref:`ref-cmd-pref-misc`
  * :ref:`ref-cmd-pref-warnings`
  * :ref:`ref-cmd-pref-examples`
...
When publishing results obtained using the PREF command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-pref-syntax:
