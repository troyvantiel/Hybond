...
**Outline:**
  ...
  * :ref:`ref-cmd-mtp-cite`
  * :ref:`ref-cmd-mtp-syntax`
  * :ref:`ref-cmd-mtp-misc`
  * :ref:`ref-cmd-mtp-warnings`
  * :ref:`ref-cmd-mtp-examples`
...
When publishing results obtained using the MTP command in CHARMM, please
