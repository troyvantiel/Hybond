...
**Outline:**
  ...
  * :ref:`ref-cmd-gbim-cite`
  * :ref:`ref-cmd-gbim-syntax`
  * :ref:`ref-cmd-gbim-misc`
  * :ref:`ref-cmd-gbim-warnings`
  * :ref:`ref-cmd-gbim-examples`
...
When publishing results obtained using the GBIM command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-gbim-syntax:
