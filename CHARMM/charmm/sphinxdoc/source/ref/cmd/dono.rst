...
**Outline:**
  ...
  * :ref:`ref-cmd-dono-cite`
  * :ref:`ref-cmd-dono-syntax`
  * :ref:`ref-cmd-dono-misc`
  * :ref:`ref-cmd-dono-warnings`
  * :ref:`ref-cmd-dono-examples`
...
When publishing results obtained using the DONO command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-dono-syntax:
