...
**Outline:**
  ...
  * :ref:`ref-cmd-para-cite`
  * :ref:`ref-cmd-para-syntax`
  * :ref:`ref-cmd-para-misc`
  * :ref:`ref-cmd-para-warnings`
  * :ref:`ref-cmd-para-examples`
...
When publishing results obtained using the PARA command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-para-syntax:
