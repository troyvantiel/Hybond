...
**Outline:**
  ...
  * :ref:`ref-cmd-pull-cite`
  * :ref:`ref-cmd-pull-syntax`
  * :ref:`ref-cmd-pull-misc`
  * :ref:`ref-cmd-pull-warnings`
  * :ref:`ref-cmd-pull-examples`
...
When publishing results obtained using the PULL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-pull-syntax:
