...
**Outline:**
  ...
  * :ref:`ref-cmd-mltc-cite`
  * :ref:`ref-cmd-mltc-syntax`
  * :ref:`ref-cmd-mltc-misc`
  * :ref:`ref-cmd-mltc-warnings`
  * :ref:`ref-cmd-mltc-examples`
...
When publishing results obtained using the MLTC command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-mltc-syntax:
