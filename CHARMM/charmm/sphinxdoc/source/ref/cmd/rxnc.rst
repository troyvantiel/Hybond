...
**Outline:**
  ...
  * :ref:`ref-cmd-rxnc-cite`
  * :ref:`ref-cmd-rxnc-syntax`
  * :ref:`ref-cmd-rxnc-misc`
  * :ref:`ref-cmd-rxnc-warnings`
  * :ref:`ref-cmd-rxnc-examples`
...
When publishing results obtained using the RXNC command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rxnc-syntax:
