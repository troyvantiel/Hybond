...
**Outline:**
  ...
  * :ref:`ref-cmd-emap-cite`
  * :ref:`ref-cmd-emap-syntax`
  * :ref:`ref-cmd-emap-misc`
  * :ref:`ref-cmd-emap-warnings`
  * :ref:`ref-cmd-emap-examples`
...
When publishing results obtained using the EMAP command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-emap-syntax:
