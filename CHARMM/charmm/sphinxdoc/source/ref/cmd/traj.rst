...
**Outline:**
  ...
  * :ref:`ref-cmd-traj-cite`
  * :ref:`ref-cmd-traj-syntax`
  * :ref:`ref-cmd-traj-misc`
  * :ref:`ref-cmd-traj-warnings`
  * :ref:`ref-cmd-traj-examples`
...
When publishing results obtained using the TRAJ command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-traj-syntax:
