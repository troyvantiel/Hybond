...
**Outline:**
  ...
  * :ref:`ref-cmd-shel-cite`
  * :ref:`ref-cmd-shel-syntax`
  * :ref:`ref-cmd-shel-misc`
  * :ref:`ref-cmd-shel-warnings`
  * :ref:`ref-cmd-shel-examples`
...
When publishing results obtained using the SHEL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-shel-syntax:
