...
**Outline:**
  ...
  * :ref:`ref-cmd-qub-cite`
  * :ref:`ref-cmd-qub-syntax`
  * :ref:`ref-cmd-qub-misc`
  * :ref:`ref-cmd-qub-warnings`
  * :ref:`ref-cmd-qub-examples`
...
When publishing results obtained using the QUB command in CHARMM, please
