...
**Outline:**
  ...
  * :ref:`ref-cmd-dims-cite`
  * :ref:`ref-cmd-dims-syntax`
  * :ref:`ref-cmd-dims-misc`
  * :ref:`ref-cmd-dims-warnings`
  * :ref:`ref-cmd-dims-examples`
...
When publishing results obtained using the DIMS command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-dims-syntax:
