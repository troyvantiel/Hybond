...
**Outline:**
  ...
  * :ref:`ref-cmd-rpat-cite`
  * :ref:`ref-cmd-rpat-syntax`
  * :ref:`ref-cmd-rpat-misc`
  * :ref:`ref-cmd-rpat-warnings`
  * :ref:`ref-cmd-rpat-examples`
...
When publishing results obtained using the RPAT command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rpat-syntax:
