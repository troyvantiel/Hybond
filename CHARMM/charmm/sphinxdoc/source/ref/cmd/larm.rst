...
**Outline:**
  ...
  * :ref:`ref-cmd-larm-cite`
  * :ref:`ref-cmd-larm-syntax`
  * :ref:`ref-cmd-larm-misc`
  * :ref:`ref-cmd-larm-warnings`
  * :ref:`ref-cmd-larm-examples`
...
When publishing results obtained using the LARM command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-larm-syntax:
