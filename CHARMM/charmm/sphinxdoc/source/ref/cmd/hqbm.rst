...
**Outline:**
  ...
  * :ref:`ref-cmd-hqbm-cite`
  * :ref:`ref-cmd-hqbm-syntax`
  * :ref:`ref-cmd-hqbm-misc`
  * :ref:`ref-cmd-hqbm-warnings`
  * :ref:`ref-cmd-hqbm-examples`
...
When publishing results obtained using the HQBM command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-hqbm-syntax:
