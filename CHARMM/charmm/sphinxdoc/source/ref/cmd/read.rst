...
**Outline:**
  ...
  * :ref:`ref-cmd-read-cite`
  * :ref:`ref-cmd-read-syntax`
  * :ref:`ref-cmd-read-misc`
  * :ref:`ref-cmd-read-warnings`
  * :ref:`ref-cmd-read-examples`
...
When publishing results obtained using the READ command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-read-syntax:
