...
**Outline:**
  ...
  * :ref:`ref-cmd-poly-cite`
  * :ref:`ref-cmd-poly-syntax`
  * :ref:`ref-cmd-poly-misc`
  * :ref:`ref-cmd-poly-warnings`
  * :ref:`ref-cmd-poly-examples`
...
When publishing results obtained using the POLY command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-poly-syntax:
