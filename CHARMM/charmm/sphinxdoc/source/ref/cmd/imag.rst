...
**Outline:**
  ...
  * :ref:`ref-cmd-imag-cite`
  * :ref:`ref-cmd-imag-syntax`
  * :ref:`ref-cmd-imag-misc`
  * :ref:`ref-cmd-imag-warnings`
  * :ref:`ref-cmd-imag-examples`
...
When publishing results obtained using the IMAG command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-imag-syntax:
