...
**Outline:**
  ...
  * :ref:`ref-cmd-pert-cite`
  * :ref:`ref-cmd-pert-syntax`
  * :ref:`ref-cmd-pert-misc`
  * :ref:`ref-cmd-pert-warnings`
  * :ref:`ref-cmd-pert-examples`
...
When publishing results obtained using the PERT command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-pert-syntax:
