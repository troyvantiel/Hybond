...
**Outline:**
  ...
  * :ref:`ref-cmd-rese-cite`
  * :ref:`ref-cmd-rese-syntax`
  * :ref:`ref-cmd-rese-misc`
  * :ref:`ref-cmd-rese-warnings`
  * :ref:`ref-cmd-rese-examples`
...
When publishing results obtained using the RESE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rese-syntax:
