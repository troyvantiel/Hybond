...
**Outline:**
  ...
  * :ref:`ref-cmd-move-cite`
  * :ref:`ref-cmd-move-syntax`
  * :ref:`ref-cmd-move-misc`
  * :ref:`ref-cmd-move-warnings`
  * :ref:`ref-cmd-move-examples`
...
When publishing results obtained using the MOVE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-move-syntax:
