...
**Outline:**
  ...
  * :ref:`ref-cmd-coor-cite`
  * :ref:`ref-cmd-coor-syntax`
  * :ref:`ref-cmd-coor-misc`
  * :ref:`ref-cmd-coor-warnings`
  * :ref:`ref-cmd-coor-examples`
...
When publishing results obtained using the COOR command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-coor-syntax:
