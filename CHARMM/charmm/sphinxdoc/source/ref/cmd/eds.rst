...
**Outline:**
  ...
  * :ref:`ref-cmd-eds-cite`
  * :ref:`ref-cmd-eds-syntax`
  * :ref:`ref-cmd-eds-misc`
  * :ref:`ref-cmd-eds-warnings`
  * :ref:`ref-cmd-eds-examples`
...
When publishing results obtained using the EDS command in CHARMM, please
