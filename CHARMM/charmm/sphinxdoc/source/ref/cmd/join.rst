...
**Outline:**
  ...
  * :ref:`ref-cmd-join-cite`
  * :ref:`ref-cmd-join-syntax`
  * :ref:`ref-cmd-join-misc`
  * :ref:`ref-cmd-join-warnings`
  * :ref:`ref-cmd-join-examples`
...
When publishing results obtained using the JOIN command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-join-syntax:
