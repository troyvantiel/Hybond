...
**Outline:**
  ...
  * :ref:`ref-cmd-fitc-cite`
  * :ref:`ref-cmd-fitc-syntax`
  * :ref:`ref-cmd-fitc-misc`
  * :ref:`ref-cmd-fitc-warnings`
  * :ref:`ref-cmd-fitc-examples`
...
When publishing results obtained using the FITC command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-fitc-syntax:
