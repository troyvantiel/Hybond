...
**Outline:**
  ...
  * :ref:`ref-cmd-lupo-cite`
  * :ref:`ref-cmd-lupo-syntax`
  * :ref:`ref-cmd-lupo-misc`
  * :ref:`ref-cmd-lupo-warnings`
  * :ref:`ref-cmd-lupo-examples`
...
When publishing results obtained using the LUPO command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-lupo-syntax:
