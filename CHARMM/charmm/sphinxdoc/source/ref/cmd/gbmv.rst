...
**Outline:**
  ...
  * :ref:`ref-cmd-gbmv-cite`
  * :ref:`ref-cmd-gbmv-syntax`
  * :ref:`ref-cmd-gbmv-misc`
  * :ref:`ref-cmd-gbmv-warnings`
  * :ref:`ref-cmd-gbmv-examples`
...
When publishing results obtained using the GBMV command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-gbmv-syntax:
