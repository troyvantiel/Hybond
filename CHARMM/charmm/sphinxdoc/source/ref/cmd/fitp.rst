...
**Outline:**
  ...
  * :ref:`ref-cmd-fitp-cite`
  * :ref:`ref-cmd-fitp-syntax`
  * :ref:`ref-cmd-fitp-misc`
  * :ref:`ref-cmd-fitp-warnings`
  * :ref:`ref-cmd-fitp-examples`
...
When publishing results obtained using the FITP command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-fitp-syntax:
