...
**Outline:**
  ...
  * :ref:`ref-cmd-shap-cite`
  * :ref:`ref-cmd-shap-syntax`
  * :ref:`ref-cmd-shap-misc`
  * :ref:`ref-cmd-shap-warnings`
  * :ref:`ref-cmd-shap-examples`
...
When publishing results obtained using the SHAP command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-shap-syntax:
