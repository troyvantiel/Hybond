...
**Outline:**
  ...
  * :ref:`ref-cmd-repl-cite`
  * :ref:`ref-cmd-repl-syntax`
  * :ref:`ref-cmd-repl-misc`
  * :ref:`ref-cmd-repl-warnings`
  * :ref:`ref-cmd-repl-examples`
...
When publishing results obtained using the REPL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-repl-syntax:
