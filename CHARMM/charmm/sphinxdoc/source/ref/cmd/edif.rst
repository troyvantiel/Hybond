...
**Outline:**
  ...
  * :ref:`ref-cmd-edif-cite`
  * :ref:`ref-cmd-edif-syntax`
  * :ref:`ref-cmd-edif-misc`
  * :ref:`ref-cmd-edif-warnings`
  * :ref:`ref-cmd-edif-examples`
...
When publishing results obtained using the EDIF command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-edif-syntax:
