...
**Outline:**
  ...
  * :ref:`ref-cmd-prot-cite`
  * :ref:`ref-cmd-prot-syntax`
  * :ref:`ref-cmd-prot-misc`
  * :ref:`ref-cmd-prot-warnings`
  * :ref:`ref-cmd-prot-examples`
...
When publishing results obtained using the PROT command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-prot-syntax:
