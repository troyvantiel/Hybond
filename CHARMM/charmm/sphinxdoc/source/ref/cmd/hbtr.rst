...
**Outline:**
  ...
  * :ref:`ref-cmd-hbtr-cite`
  * :ref:`ref-cmd-hbtr-syntax`
  * :ref:`ref-cmd-hbtr-misc`
  * :ref:`ref-cmd-hbtr-warnings`
  * :ref:`ref-cmd-hbtr-examples`
...
When publishing results obtained using the HBTR command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-hbtr-syntax:
