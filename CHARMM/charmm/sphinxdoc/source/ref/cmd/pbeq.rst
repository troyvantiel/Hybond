...
**Outline:**
  ...
  * :ref:`ref-cmd-pbeq-cite`
  * :ref:`ref-cmd-pbeq-syntax`
  * :ref:`ref-cmd-pbeq-misc`
  * :ref:`ref-cmd-pbeq-warnings`
  * :ref:`ref-cmd-pbeq-examples`
...
When publishing results obtained using the PBEQ command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-pbeq-syntax:
