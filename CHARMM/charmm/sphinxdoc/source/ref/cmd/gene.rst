...
**Outline:**
  ...
  * :ref:`ref-cmd-gene-cite`
  * :ref:`ref-cmd-gene-syntax`
  * :ref:`ref-cmd-gene-misc`
  * :ref:`ref-cmd-gene-warnings`
  * :ref:`ref-cmd-gene-examples`
...
When publishing results obtained using the GENE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-gene-syntax:
