...
**Outline:**
  ...
  * :ref:`ref-cmd-dime-cite`
  * :ref:`ref-cmd-dime-syntax`
  * :ref:`ref-cmd-dime-misc`
  * :ref:`ref-cmd-dime-warnings`
  * :ref:`ref-cmd-dime-examples`
...
When publishing results obtained using the DIME command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-dime-syntax:
