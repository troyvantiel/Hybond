...
**Outline:**
  ...
  * :ref:`ref-cmd-cpus-cite`
  * :ref:`ref-cmd-cpus-syntax`
  * :ref:`ref-cmd-cpus-misc`
  * :ref:`ref-cmd-cpus-warnings`
  * :ref:`ref-cmd-cpus-examples`
...
When publishing results obtained using the CPUS command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-cpus-syntax:
