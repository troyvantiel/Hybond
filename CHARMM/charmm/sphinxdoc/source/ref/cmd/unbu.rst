...
**Outline:**
  ...
  * :ref:`ref-cmd-unbu-cite`
  * :ref:`ref-cmd-unbu-syntax`
  * :ref:`ref-cmd-unbu-misc`
  * :ref:`ref-cmd-unbu-warnings`
  * :ref:`ref-cmd-unbu-examples`
...
When publishing results obtained using the UNBU command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-unbu-syntax:
