...
**Outline:**
  ...
  * :ref:`ref-cmd-mast-cite`
  * :ref:`ref-cmd-mast-syntax`
  * :ref:`ref-cmd-mast-misc`
  * :ref:`ref-cmd-mast-warnings`
  * :ref:`ref-cmd-mast-examples`
...
When publishing results obtained using the MAST command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-mast-syntax:
