...
**Outline:**
  ...
  * :ref:`ref-cmd-cnsp-cite`
  * :ref:`ref-cmd-cnsp-syntax`
  * :ref:`ref-cmd-cnsp-misc`
  * :ref:`ref-cmd-cnsp-warnings`
  * :ref:`ref-cmd-cnsp-examples`
...
When publishing results obtained using the CNSP command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-cnsp-syntax:
