...
**Outline:**
  ...
  * :ref:`ref-cmd-boun-cite`
  * :ref:`ref-cmd-boun-syntax`
  * :ref:`ref-cmd-boun-misc`
  * :ref:`ref-cmd-boun-warnings`
  * :ref:`ref-cmd-boun-examples`
...
When publishing results obtained using the BOUN command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-boun-syntax:
