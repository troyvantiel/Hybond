...
**Outline:**
  ...
  * :ref:`ref-cmd-gaus-cite`
  * :ref:`ref-cmd-gaus-syntax`
  * :ref:`ref-cmd-gaus-misc`
  * :ref:`ref-cmd-gaus-warnings`
  * :ref:`ref-cmd-gaus-examples`
...
When publishing results obtained using the GAUS command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-gaus-syntax:
