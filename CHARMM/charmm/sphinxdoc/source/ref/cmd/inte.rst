...
**Outline:**
  ...
  * :ref:`ref-cmd-inte-cite`
  * :ref:`ref-cmd-inte-syntax`
  * :ref:`ref-cmd-inte-misc`
  * :ref:`ref-cmd-inte-warnings`
  * :ref:`ref-cmd-inte-examples`
...
When publishing results obtained using the INTE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-inte-syntax:
