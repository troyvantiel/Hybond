...
**Outline:**
  ...
  * :ref:`ref-cmd-pres-cite`
  * :ref:`ref-cmd-pres-syntax`
  * :ref:`ref-cmd-pres-misc`
  * :ref:`ref-cmd-pres-warnings`
  * :ref:`ref-cmd-pres-examples`
...
When publishing results obtained using the PRES command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-pres-syntax:
