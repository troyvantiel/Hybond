...
**Outline:**
  ...
  * :ref:`ref-cmd-nose-cite`
  * :ref:`ref-cmd-nose-syntax`
  * :ref:`ref-cmd-nose-misc`
  * :ref:`ref-cmd-nose-warnings`
  * :ref:`ref-cmd-nose-examples`
...
When publishing results obtained using the NOSE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-nose-syntax:
