...
**Outline:**
  ...
  * :ref:`ref-cmd-rism-cite`
  * :ref:`ref-cmd-rism-syntax`
  * :ref:`ref-cmd-rism-misc`
  * :ref:`ref-cmd-rism-warnings`
  * :ref:`ref-cmd-rism-examples`
...
When publishing results obtained using the RISM command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rism-syntax:
