...
**Outline:**
  ...
  * :ref:`ref-cmd-rate-cite`
  * :ref:`ref-cmd-rate-syntax`
  * :ref:`ref-cmd-rate-misc`
  * :ref:`ref-cmd-rate-warnings`
  * :ref:`ref-cmd-rate-examples`
...
When publishing results obtained using the RATE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rate-syntax:
