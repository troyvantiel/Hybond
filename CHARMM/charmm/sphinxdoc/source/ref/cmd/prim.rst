...
**Outline:**
  ...
  * :ref:`ref-cmd-prim-cite`
  * :ref:`ref-cmd-prim-syntax`
  * :ref:`ref-cmd-prim-misc`
  * :ref:`ref-cmd-prim-warnings`
  * :ref:`ref-cmd-prim-examples`
...
When publishing results obtained using the PRIM command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-prim-syntax:
