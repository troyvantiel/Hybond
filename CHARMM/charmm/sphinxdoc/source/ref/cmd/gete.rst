...
**Outline:**
  ...
  * :ref:`ref-cmd-gete-cite`
  * :ref:`ref-cmd-gete-syntax`
  * :ref:`ref-cmd-gete-misc`
  * :ref:`ref-cmd-gete-warnings`
  * :ref:`ref-cmd-gete-examples`
...
When publishing results obtained using the GETE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-gete-syntax:
