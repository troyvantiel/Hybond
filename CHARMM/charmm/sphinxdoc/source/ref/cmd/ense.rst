...
**Outline:**
  ...
  * :ref:`ref-cmd-ense-cite`
  * :ref:`ref-cmd-ense-syntax`
  * :ref:`ref-cmd-ense-misc`
  * :ref:`ref-cmd-ense-warnings`
  * :ref:`ref-cmd-ense-examples`
...
When publishing results obtained using the ENSE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-ense-syntax:
