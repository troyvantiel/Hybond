...
**Outline:**
  ...
  * :ref:`ref-cmd-vibr-cite`
  * :ref:`ref-cmd-vibr-syntax`
  * :ref:`ref-cmd-vibr-misc`
  * :ref:`ref-cmd-vibr-warnings`
  * :ref:`ref-cmd-vibr-examples`
...
When publishing results obtained using the VIBR command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-vibr-syntax:
