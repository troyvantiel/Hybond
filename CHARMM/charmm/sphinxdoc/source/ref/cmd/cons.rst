...
**Outline:**
  ...
  * :ref:`ref-cmd-cons-cite`
  * :ref:`ref-cmd-cons-syntax`
  * :ref:`ref-cmd-cons-misc`
  * :ref:`ref-cmd-cons-warnings`
  * :ref:`ref-cmd-cons-examples`
...
When publishing results obtained using the CONS command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-cons-syntax:
