...
**Outline:**
  ...
  * :ref:`ref-cmd-olap-cite`
  * :ref:`ref-cmd-olap-syntax`
  * :ref:`ref-cmd-olap-misc`
  * :ref:`ref-cmd-olap-warnings`
  * :ref:`ref-cmd-olap-examples`
...
When publishing results obtained using the OLAP command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-olap-syntax:
