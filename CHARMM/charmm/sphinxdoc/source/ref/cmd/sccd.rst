...
**Outline:**
  ...
  * :ref:`ref-cmd-sccd-cite`
  * :ref:`ref-cmd-sccd-syntax`
  * :ref:`ref-cmd-sccd-misc`
  * :ref:`ref-cmd-sccd-warnings`
  * :ref:`ref-cmd-sccd-examples`
...
When publishing results obtained using the SCCD command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-sccd-syntax:
