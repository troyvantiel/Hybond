...
**Outline:**
  ...
  * :ref:`ref-cmd-mmfp-cite`
  * :ref:`ref-cmd-mmfp-syntax`
  * :ref:`ref-cmd-mmfp-misc`
  * :ref:`ref-cmd-mmfp-warnings`
  * :ref:`ref-cmd-mmfp-examples`
...
When publishing results obtained using the MMFP command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-mmfp-syntax:
