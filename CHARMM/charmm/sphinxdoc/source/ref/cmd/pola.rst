...
**Outline:**
  ...
  * :ref:`ref-cmd-pola-cite`
  * :ref:`ref-cmd-pola-syntax`
  * :ref:`ref-cmd-pola-misc`
  * :ref:`ref-cmd-pola-warnings`
  * :ref:`ref-cmd-pola-examples`
...
When publishing results obtained using the POLA command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-pola-syntax:
