...
**Outline:**
  ...
  * :ref:`ref-cmd-cvel-cite`
  * :ref:`ref-cmd-cvel-syntax`
  * :ref:`ref-cmd-cvel-misc`
  * :ref:`ref-cmd-cvel-warnings`
  * :ref:`ref-cmd-cvel-examples`
...
When publishing results obtained using the CVEL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-cvel-syntax:
