...
**Outline:**
  ...
  * :ref:`ref-cmd-hbui-cite`
  * :ref:`ref-cmd-hbui-syntax`
  * :ref:`ref-cmd-hbui-misc`
  * :ref:`ref-cmd-hbui-warnings`
  * :ref:`ref-cmd-hbui-examples`
...
When publishing results obtained using the HBUI command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-hbui-syntax:
