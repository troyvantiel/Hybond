...
**Outline:**
  ...
  * :ref:`ref-cmd-rdfs-cite`
  * :ref:`ref-cmd-rdfs-syntax`
  * :ref:`ref-cmd-rdfs-misc`
  * :ref:`ref-cmd-rdfs-warnings`
  * :ref:`ref-cmd-rdfs-examples`
...
When publishing results obtained using the RDFS command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rdfs-syntax:
