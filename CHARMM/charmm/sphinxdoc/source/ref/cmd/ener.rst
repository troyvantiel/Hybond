...
**Outline:**
  ...
  * :ref:`ref-cmd-ener-cite`
  * :ref:`ref-cmd-ener-syntax`
  * :ref:`ref-cmd-ener-misc`
  * :ref:`ref-cmd-ener-warnings`
  * :ref:`ref-cmd-ener-examples`
...
When publishing results obtained using the ENER command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-ener-syntax:
