...
**Outline:**
  ...
  * :ref:`ref-cmd-quan-cite`
  * :ref:`ref-cmd-quan-syntax`
  * :ref:`ref-cmd-quan-misc`
  * :ref:`ref-cmd-quan-warnings`
  * :ref:`ref-cmd-quan-examples`
...
When publishing results obtained using the QUAN command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-quan-syntax:
