...
**Outline:**
  ...
  * :ref:`ref-cmd-rmsd-cite`
  * :ref:`ref-cmd-rmsd-syntax`
  * :ref:`ref-cmd-rmsd-misc`
  * :ref:`ref-cmd-rmsd-warnings`
  * :ref:`ref-cmd-rmsd-examples`
...
When publishing results obtained using the RMSD command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rmsd-syntax:
