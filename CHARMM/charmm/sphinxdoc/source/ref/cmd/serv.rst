...
**Outline:**
  ...
  * :ref:`ref-cmd-serv-cite`
  * :ref:`ref-cmd-serv-syntax`
  * :ref:`ref-cmd-serv-misc`
  * :ref:`ref-cmd-serv-warnings`
  * :ref:`ref-cmd-serv-examples`
...
When publishing results obtained using the SERV command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-serv-syntax:
