...
**Outline:**
  ...
  * :ref:`ref-cmd-msca-cite`
  * :ref:`ref-cmd-msca-syntax`
  * :ref:`ref-cmd-msca-misc`
  * :ref:`ref-cmd-msca-warnings`
  * :ref:`ref-cmd-msca-examples`
...
When publishing results obtained using the MSCA command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-msca-syntax:
