...
**Outline:**
  ...
  * :ref:`ref-cmd-moni-cite`
  * :ref:`ref-cmd-moni-syntax`
  * :ref:`ref-cmd-moni-misc`
  * :ref:`ref-cmd-moni-warnings`
  * :ref:`ref-cmd-moni-examples`
...
When publishing results obtained using the MONI command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-moni-syntax:
