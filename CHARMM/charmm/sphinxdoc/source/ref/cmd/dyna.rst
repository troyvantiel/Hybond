...
**Outline:**
  ...
  * :ref:`ref-cmd-dyna-cite`
  * :ref:`ref-cmd-dyna-syntax`
  * :ref:`ref-cmd-dyna-misc`
  * :ref:`ref-cmd-dyna-warnings`
  * :ref:`ref-cmd-dyna-examples`
...
When publishing results obtained using the DYNA command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-dyna-syntax:
