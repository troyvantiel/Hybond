...
**Outline:**
  ...
  * :ref:`ref-cmd-scpi-cite`
  * :ref:`ref-cmd-scpi-syntax`
  * :ref:`ref-cmd-scpi-misc`
  * :ref:`ref-cmd-scpi-warnings`
  * :ref:`ref-cmd-scpi-examples`
...
When publishing results obtained using the SCPI command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-scpi-syntax:
