...
**Outline:**
  ...
  * :ref:`ref-cmd-writ-cite`
  * :ref:`ref-cmd-writ-syntax`
  * :ref:`ref-cmd-writ-misc`
  * :ref:`ref-cmd-writ-warnings`
  * :ref:`ref-cmd-writ-examples`
...
When publishing results obtained using the WRIT command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-writ-syntax:
