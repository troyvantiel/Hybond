...
**Outline:**
  ...
  * :ref:`ref-cmd-resi-cite`
  * :ref:`ref-cmd-resi-syntax`
  * :ref:`ref-cmd-resi-misc`
  * :ref:`ref-cmd-resi-warnings`
  * :ref:`ref-cmd-resi-examples`
...
When publishing results obtained using the RESI command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-resi-syntax:
