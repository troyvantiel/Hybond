...
**Outline:**
  ...
  * :ref:`ref-cmd-impa-cite`
  * :ref:`ref-cmd-impa-syntax`
  * :ref:`ref-cmd-impa-misc`
  * :ref:`ref-cmd-impa-warnings`
  * :ref:`ref-cmd-impa-examples`
...
When publishing results obtained using the IMPA command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-impa-syntax:
