...
**Outline:**
  ...
  * :ref:`ref-cmd-qtur-cite`
  * :ref:`ref-cmd-qtur-syntax`
  * :ref:`ref-cmd-qtur-misc`
  * :ref:`ref-cmd-qtur-warnings`
  * :ref:`ref-cmd-qtur-examples`
...
When publishing results obtained using the QTUR command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-qtur-syntax:
