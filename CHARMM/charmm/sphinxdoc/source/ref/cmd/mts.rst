...
**Outline:**
  ...
  * :ref:`ref-cmd-mts-cite`
  * :ref:`ref-cmd-mts-syntax`
  * :ref:`ref-cmd-mts-misc`
  * :ref:`ref-cmd-mts-warnings`
  * :ref:`ref-cmd-mts-examples`
...
When publishing results obtained using the MTS command in CHARMM, please
