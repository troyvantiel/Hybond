...
**Outline:**
  ...
  * :ref:`ref-cmd-four-cite`
  * :ref:`ref-cmd-four-syntax`
  * :ref:`ref-cmd-four-misc`
  * :ref:`ref-cmd-four-warnings`
  * :ref:`ref-cmd-four-examples`
...
When publishing results obtained using the FOUR command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-four-syntax:
