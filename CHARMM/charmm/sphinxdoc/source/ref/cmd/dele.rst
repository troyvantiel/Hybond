...
**Outline:**
  ...
  * :ref:`ref-cmd-dele-cite`
  * :ref:`ref-cmd-dele-syntax`
  * :ref:`ref-cmd-dele-misc`
  * :ref:`ref-cmd-dele-warnings`
  * :ref:`ref-cmd-dele-examples`
...
When publishing results obtained using the DELE command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-dele-syntax:
