...
**Outline:**
  ...
  * :ref:`ref-cmd-draw-cite`
  * :ref:`ref-cmd-draw-syntax`
  * :ref:`ref-cmd-draw-misc`
  * :ref:`ref-cmd-draw-warnings`
  * :ref:`ref-cmd-draw-examples`
...
When publishing results obtained using the DRAW command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-draw-syntax:
