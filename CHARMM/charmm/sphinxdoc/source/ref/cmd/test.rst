...
**Outline:**
  ...
  * :ref:`ref-cmd-test-cite`
  * :ref:`ref-cmd-test-syntax`
  * :ref:`ref-cmd-test-misc`
  * :ref:`ref-cmd-test-warnings`
  * :ref:`ref-cmd-test-examples`
...
When publishing results obtained using the TEST command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-test-syntax:
