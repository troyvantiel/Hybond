...
**Outline:**
  ...
  * :ref:`ref-cmd-tamd-cite`
  * :ref:`ref-cmd-tamd-syntax`
  * :ref:`ref-cmd-tamd-misc`
  * :ref:`ref-cmd-tamd-warnings`
  * :ref:`ref-cmd-tamd-examples`
...
When publishing results obtained using the TAMD command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-tamd-syntax:
