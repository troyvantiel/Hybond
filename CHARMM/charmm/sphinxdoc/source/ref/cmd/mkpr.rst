...
**Outline:**
  ...
  * :ref:`ref-cmd-mkpr-cite`
  * :ref:`ref-cmd-mkpr-syntax`
  * :ref:`ref-cmd-mkpr-misc`
  * :ref:`ref-cmd-mkpr-warnings`
  * :ref:`ref-cmd-mkpr-examples`
...
When publishing results obtained using the MKPR command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-mkpr-syntax:
