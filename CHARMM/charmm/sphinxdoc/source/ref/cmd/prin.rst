...
**Outline:**
  ...
  * :ref:`ref-cmd-prin-cite`
  * :ref:`ref-cmd-prin-syntax`
  * :ref:`ref-cmd-prin-misc`
  * :ref:`ref-cmd-prin-warnings`
  * :ref:`ref-cmd-prin-examples`
...
When publishing results obtained using the PRIN command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-prin-syntax:
