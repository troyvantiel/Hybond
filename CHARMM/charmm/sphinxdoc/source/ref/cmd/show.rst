...
**Outline:**
  ...
  * :ref:`ref-cmd-show-cite`
  * :ref:`ref-cmd-show-syntax`
  * :ref:`ref-cmd-show-misc`
  * :ref:`ref-cmd-show-warnings`
  * :ref:`ref-cmd-show-examples`
...
When publishing results obtained using the SHOW command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-show-syntax:
