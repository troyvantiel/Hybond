...
**Outline:**
  ...
  * :ref:`ref-cmd-mull-cite`
  * :ref:`ref-cmd-mull-syntax`
  * :ref:`ref-cmd-mull-misc`
  * :ref:`ref-cmd-mull-warnings`
  * :ref:`ref-cmd-mull-examples`
...
When publishing results obtained using the MULL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-mull-syntax:
