...
**Outline:**
  ...
  * :ref:`ref-cmd-rell-cite`
  * :ref:`ref-cmd-rell-syntax`
  * :ref:`ref-cmd-rell-misc`
  * :ref:`ref-cmd-rell-warnings`
  * :ref:`ref-cmd-rell-examples`
...
When publishing results obtained using the RELL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rell-syntax:
