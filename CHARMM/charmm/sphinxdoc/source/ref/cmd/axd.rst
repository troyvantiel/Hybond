...
**Outline:**
  ...
  * :ref:`ref-cmd-axd-cite`
  * :ref:`ref-cmd-axd-syntax`
  * :ref:`ref-cmd-axd-misc`
  * :ref:`ref-cmd-axd-warnings`
  * :ref:`ref-cmd-axd-examples`
...
When publishing results obtained using the AXD command in CHARMM, please
