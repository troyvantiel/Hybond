...
**Outline:**
  ...
  * :ref:`ref-cmd-grap-cite`
  * :ref:`ref-cmd-grap-syntax`
  * :ref:`ref-cmd-grap-misc`
  * :ref:`ref-cmd-grap-warnings`
  * :ref:`ref-cmd-grap-examples`
...
When publishing results obtained using the GRAP command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-grap-syntax:
