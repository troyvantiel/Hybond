...
**Outline:**
  ...
  * :ref:`ref-cmd-tmdi-cite`
  * :ref:`ref-cmd-tmdi-syntax`
  * :ref:`ref-cmd-tmdi-misc`
  * :ref:`ref-cmd-tmdi-warnings`
  * :ref:`ref-cmd-tmdi-examples`
...
When publishing results obtained using the TMDI command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-tmdi-syntax:
