...
**Outline:**
  ...
  * :ref:`ref-cmd-mcma-cite`
  * :ref:`ref-cmd-mcma-syntax`
  * :ref:`ref-cmd-mcma-misc`
  * :ref:`ref-cmd-mcma-warnings`
  * :ref:`ref-cmd-mcma-examples`
...
When publishing results obtained using the MCMA command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-mcma-syntax:
