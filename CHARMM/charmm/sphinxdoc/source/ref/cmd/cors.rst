...
**Outline:**
  ...
  * :ref:`ref-cmd-cors-cite`
  * :ref:`ref-cmd-cors-syntax`
  * :ref:`ref-cmd-cors-misc`
  * :ref:`ref-cmd-cors-warnings`
  * :ref:`ref-cmd-cors-examples`
...
When publishing results obtained using the CORS command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-cors-syntax:
