...
**Outline:**
  ...
  * :ref:`ref-cmd-tsal-cite`
  * :ref:`ref-cmd-tsal-syntax`
  * :ref:`ref-cmd-tsal-misc`
  * :ref:`ref-cmd-tsal-warnings`
  * :ref:`ref-cmd-tsal-examples`
...
When publishing results obtained using the TSAL command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-tsal-syntax:
