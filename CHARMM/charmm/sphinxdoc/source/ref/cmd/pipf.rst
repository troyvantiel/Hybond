...
**Outline:**
  ...
  * :ref:`ref-cmd-pipf-cite`
  * :ref:`ref-cmd-pipf-syntax`
  * :ref:`ref-cmd-pipf-misc`
  * :ref:`ref-cmd-pipf-warnings`
  * :ref:`ref-cmd-pipf-examples`
...
When publishing results obtained using the PIPF command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-pipf-syntax:
