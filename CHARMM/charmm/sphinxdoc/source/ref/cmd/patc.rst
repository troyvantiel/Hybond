...
**Outline:**
  ...
  * :ref:`ref-cmd-patc-cite`
  * :ref:`ref-cmd-patc-syntax`
  * :ref:`ref-cmd-patc-misc`
  * :ref:`ref-cmd-patc-warnings`
  * :ref:`ref-cmd-patc-examples`
...
When publishing results obtained using the PATC command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-patc-syntax:
