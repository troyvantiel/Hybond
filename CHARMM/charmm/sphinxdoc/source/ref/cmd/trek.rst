...
**Outline:**
  ...
  * :ref:`ref-cmd-trek-cite`
  * :ref:`ref-cmd-trek-syntax`
  * :ref:`ref-cmd-trek-misc`
  * :ref:`ref-cmd-trek-warnings`
  * :ref:`ref-cmd-trek-examples`
...
When publishing results obtained using the TREK command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-trek-syntax:
