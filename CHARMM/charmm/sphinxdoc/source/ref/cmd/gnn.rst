...
**Outline:**
  ...
  * :ref:`ref-cmd-gnn-cite`
  * :ref:`ref-cmd-gnn-syntax`
  * :ref:`ref-cmd-gnn-misc`
  * :ref:`ref-cmd-gnn-warnings`
  * :ref:`ref-cmd-gnn-examples`
...
When publishing results obtained using the GNN command in CHARMM, please
