...
**Outline:**
  ...
  * :ref:`ref-cmd-rush-cite`
  * :ref:`ref-cmd-rush-syntax`
  * :ref:`ref-cmd-rush-misc`
  * :ref:`ref-cmd-rush-warnings`
  * :ref:`ref-cmd-rush-examples`
...
When publishing results obtained using the RUSH command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rush-syntax:
