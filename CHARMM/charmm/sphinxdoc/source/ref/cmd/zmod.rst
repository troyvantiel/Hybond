...
**Outline:**
  ...
  * :ref:`ref-cmd-zmod-cite`
  * :ref:`ref-cmd-zmod-syntax`
  * :ref:`ref-cmd-zmod-misc`
  * :ref:`ref-cmd-zmod-warnings`
  * :ref:`ref-cmd-zmod-examples`
...
When publishing results obtained using the ZMOD command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-zmod-syntax:
