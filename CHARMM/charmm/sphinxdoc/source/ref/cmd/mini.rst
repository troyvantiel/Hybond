...
**Outline:**
  ...
  * :ref:`ref-cmd-mini-cite`
  * :ref:`ref-cmd-mini-syntax`
  * :ref:`ref-cmd-mini-misc`
  * :ref:`ref-cmd-mini-warnings`
  * :ref:`ref-cmd-mini-examples`
...
When publishing results obtained using the MINI command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-mini-syntax:
