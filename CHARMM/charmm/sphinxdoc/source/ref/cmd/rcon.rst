...
**Outline:**
  ...
  * :ref:`ref-cmd-rcon-cite`
  * :ref:`ref-cmd-rcon-syntax`
  * :ref:`ref-cmd-rcon-misc`
  * :ref:`ref-cmd-rcon-warnings`
  * :ref:`ref-cmd-rcon-examples`
...
When publishing results obtained using the RCON command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-rcon-syntax:
