...
**Outline:**
  ...
  * :ref:`ref-cmd-bari-cite`
  * :ref:`ref-cmd-bari-syntax`
  * :ref:`ref-cmd-bari-misc`
  * :ref:`ref-cmd-bari-warnings`
  * :ref:`ref-cmd-bari-examples`
...
When publishing results obtained using the BARI command in CHARMM, please
include the following literature citations:

  * Citation 1
  * Citation 2

.. _ref-cmd-bari-syntax:
