...
!#define __A__B __A__B
!#define __A__B __A##__B
!
...
!
      SUBROUTINE RSORT( ID, N, D, INFO )
      use stream
      implicit none
      character(len=len("RSORT>") ),parameter::whoami="RSORT>";!macro
!
...
! .. Local Scalars ..
      ...
      real(chm_real) :: D1, D2, D3, DMNMX, TMP
! ..
! .. Local Arrays ..
      integer :: STACK( 2, 32 )
! ..
...
!
      ...
      IF( DIR.EQ.-1 ) THEN
         INFO = -1
         call wrndie(0,whoami,trim('INVALID SORT ORDER SELECTED. ABORT.'))
         return
      ELSE IF( N.LT.0 ) THEN
         INFO = -2
         call wrndie(0,whoami,trim('NUMBER OF ARRAY ELEMENTS MUST BE POSITIVE. ABORT.'))
         return
      END IF
!
