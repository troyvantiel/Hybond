...
288    FORMAT(' <UPINB>: NBXMOD MODE IS OUT OF RANGE.',I5)
    ...
    DO WHILE(.NOT.CMPLTD)
       ...
       CALL MAKINB(NATOM,IB,JB,NBOND,INB,IBLO,NNB,BNBNDX%INB14, &
  ...
  SUBROUTINE MAKINB(NATOM,IB,JB,NBOND,INB,IBLO,NNB, &
    ...
    INTEGER NATOM,NBOND,NNB,NNB14,MXNB14,MODE,IATMXB
    INTEGER IB(*),JB(*)
