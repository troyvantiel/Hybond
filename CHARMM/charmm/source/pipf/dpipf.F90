      ...
      SUBROUTINE DPIPF(IFRSTA,NATOM,JNB,INBLO,CG, &
...
!     PFCTOF - polarization energy cut-off
!     ALP - polarizability  
...
#undef PIPF_DAMP
      ENDIF
      RETURN
    END SUBROUTINE DPIPF
#endif /* (pipf_main)*/
subroutine dpipf_dummy()
  return
end subroutine dpipf_dummy
